    ...
    $('.reg_form').ccvalidate({
        onvalidate: function (isValid) {
            if (!isValid) {
                ...
                document.getElementById("lblInvalidNumber").style.color = "red";
                document.getElementById('lblInvalidNumber').innerText = "Invalid Credit Card Number";
                return false;
            }
        }
    });
    ...
    $.fn.extend({
        ccvalidate: function(options) {
            ...
            return this.each(function() {
                var type = $(this).find('.CardType');
                var cardnumber = $(this).find('.CardNumber');
                var checkout = $(this).find('.submitPayment');
